...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    price DECIMAL(20,8) NOT NULL COMMENT '체결 가격 (소수점 8자리 - 저가코인 대응)',
    fee DECIMAL(20,8) DEFAULT 0.00000000 COMMENT '거래 수수료',
    ...
    sold_price DECIMAL(20,8) NULL COMMENT '매도 가격',
    profit_loss DECIMAL(20,8) NULL COMMENT '손익',
    profit_loss_pct DECIMAL(10,4) NULL COMMENT '수익률 (%)',
    target_sell_price DECIMAL(20,8) NULL COMMENT '목표 매도가',
    stop_loss_price DECIMAL(20,8) NULL COMMENT '손절가',
...
CREATE TABLE IF NOT EXISTS price_history (
    ...
    ma7 DECIMAL(20,8) NULL COMMENT '7일 이동평균',
    ma20 DECIMAL(20,8) NULL COMMENT '20일 이동평균',
    ma30 DECIMAL(20,8) NULL COMMENT '30일 이동평균',
    rsi DECIMAL(5,2) NULL COMMENT 'RSI 지표',
    bb_upper DECIMAL(20,8) NULL COMMENT '볼린저밴드 상단',
    bb_lower DECIMAL(20,8) NULL COMMENT '볼린저밴드 하단',
...
CREATE TABLE IF NOT EXISTS daily_summary (
    ...
    user_id VARCHAR(50) NOT NULL,
    date DATE NOT NULL,
    total_profit DECIMAL(20,8) DEFAULT 0.00 COMMENT '일일 총 손익',
    ...
    total_investment DECIMAL(20,8) DEFAULT 0.00 COMMENT '총 투자금액',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS stock_transactions (
    ...
    fee DECIMAL(20,8) DEFAULT 0.00 COMMENT '거래 수수료',
    total_amount DECIMAL(20,8) NOT NULL COMMENT '총 거래 금액',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '매수 시각',
    sold_at TIMESTAMP NULL COMMENT '매도 시각',
    sold_price DECIMAL(20,8) NULL COMMENT '매도 가격',
...
CREATE TABLE IF NOT EXISTS stock_price_history (
    ...
    price DECIMAL(20,8) NOT NULL COMMENT '종가',
    volume BIGINT NOT NULL COMMENT '거래량',
    timestamp DATE NOT NULL COMMENT '거래일',
    open_price DECIMAL(20,8) NULL COMMENT '시가',
    high_price DECIMAL(20,8) NULL COMMENT '고가',
    low_price DECIMAL(20,8) NULL COMMENT '저가',
    ma7 DECIMAL(20,8) NULL,
    ma20 DECIMAL(20,8) NULL,
    ma30 DECIMAL(20,8) NULL,
...
CREATE TABLE IF NOT EXISTS stock_daily_summary (
    ...
    total_investment DECIMAL(20,8) DEFAULT 0.00,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE CASCADE,
