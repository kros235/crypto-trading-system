...
- 752,000원 손해로 제한 (전액 손실 방지)`,
  ...
  },
 {
   category: 'trading',
   term: 'Top10 자동 운영',
   description: '시가총액 상위 10개 코인 기준으로 거래 종목을 매일 자동으로 편입/편출.',
   simpleDesc: '나스닥100 ETF처럼, 매일 새벽 시가총액 상위 10개로 거래 종목이 자동 교체되는 기능',
   exampleIcon: 'mdi-autorenew',
   exampleTitle: '📊 ETF 리밸런싱 비유',
   example: `나스닥100 ETF가 주기적으로 종목을 바꾸듯,<br/>
이 옵션을 켜면 <strong>매일 04:00 KST</strong>에 시가총액 상위 10개 코인 기준으로<br/>
거래 종목이 자동으로 교체됩니다.<br/><br/>
📊 <strong>예시:</strong><br/>
어제 Top10에 있던 A코인이 오늘 11위로 밀려나고<br/>
F코인이 10위로 올라오면<br/>
→ A 편출, F 편입으로 자동 반영 (Discord/이메일 알림 발송)<br/><br/>
⚠️ <strong>편출된 종목의 기존 보유분은?</strong><br/>
강제로 매도되지 않습니다. 목표 수익률/손절매/트레일링 스톱<br/>
조건을 충족할 때만 정상적으로 매도되며, 편출 기간에는<br/>
<strong>신규 매수만 중단</strong>됩니다. 재편입되면 매수가 재개됩니다.`,
   table: {
     headers: ['항목', '내용'],
     rows: [
       ['갱신 주기', '매일 04:00 KST (시가총액 순위 갱신 직후)'],
       ['적용 대상', '거래 설정에서 옵션을 켠 사용자만'],
       ['개별 종목 선택', '자동 운영 중에는 비활성화 (시스템이 관리)'],
       ['변경 없는 날', '알림 발송 안 됨']
     ]
   }
 },
